...
{
	auto p1 = pfr::create_helper<actor>::create(
		"dog", 1, std::string("dog1"), (const char*)"d1");
	auto p2 = pfr::create_helper<std::shared_ptr<actor>>::create(
		"dog", 2, std::string("dog2"), (const char*)"d2");
	auto p3 = pfr::create_helper<std::unique_ptr<actor>>::create(
		"dog", 3, std::string("dog3"), (const char*)"d3");
