...
#ifdef __FreeBSD__
#define BHO_PLATFORM "FreeBSD " BHO_STRINGIZE(__FreeBSD__)
#elif defined(__NetBSD__)
#define BHO_PLATFORM "NetBSD " BHO_STRINGIZE(__NetBSD__)
#elif defined(__OpenBSD__)
#define BHO_PLATFORM "OpenBSD " BHO_STRINGIZE(__OpenBSD__)
#elif defined(__DragonFly__)
#define BHO_PLATFORM "DragonFly " BHO_STRINGIZE(__DragonFly__)
#endif
