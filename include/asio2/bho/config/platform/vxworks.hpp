...
#ifndef BHO_LOCALE_WITH_ICU
   #define BHO_LOCALE_WITH_ICU
#endif
...
#  define BHO_THREAD_USES_GETPAGESIZE
#endif
...
#  define BHO_NO_CXX11_ADDRESSOF      // C11 addressof operator on memory location
#  define BHO_NO_CXX11_ALLOCATOR
#  define BHO_NO_CXX11_ATOMIC_SMART_PTR
#  define BHO_NO_CXX11_NUMERIC_LIMITS  // max_digits10 in test/../print_helper.hpp
...
#  define BHO_NO_CXX11_HDR_FORWARD_LIST  //serialization/test/test_list.cpp
#  define BHO_NO_CXX11_HDR_FUNCTIONAL 
#  define BHO_NO_CXX11_HDR_FUTURE
#  define BHO_NO_CXX11_HDR_MUTEX
#  define BHO_NO_CXX11_HDR_RANDOM      //math/../test_data.hpp
...
#else
#  ifndef  BHO_SYSTEM_NO_DEPRECATED
#    define BHO_SYSTEM_NO_DEPRECATED  // workaround link error in spirit
#  endif
#endif
...
#  ifndef BHO_ASIO_HAS_POSIX_STREAM_DESCRIPTOR
#    define BHO_ASIO_HAS_POSIX_STREAM_DESCRIPTOR
#  endif
#else 
