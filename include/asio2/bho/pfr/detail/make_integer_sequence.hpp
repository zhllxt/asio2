...
#ifndef BHO_PFR_DETAIL_MAKE_INTEGER_SEQUENCE_HPP
...
#if BHO_PFR_USE_STD_MAKE_INTEGRAL_SEQUENCE == 0

#ifdef __has_builtin
#   if __has_builtin(__make_integer_seq)
#       define BHO_PFR_USE_MAKE_INTEGER_SEQ_BUILTIN
#   endif
#endif

#ifdef BHO_PFR_USE_MAKE_INTEGER_SEQ_BUILTIN
...
#undef BHO_PFR_USE_MAKE_INTEGER_SEQ_BUILTIN
...
#endif // !defined BHO_PFR_USE_MAKE_INTEGER_SEQ_BUILTIN
#else // BHO_PFR_USE_STD_MAKE_INTEGRAL_SEQUENCE == 1

template <typename T, T N>
using make_integer_sequence = std::make_integer_sequence<T, N>;

#endif // BHO_PFR_USE_STD_MAKE_INTEGRAL_SEQUENCE == 1
