...
#include <asio2/bho/intrusive/slist.hpp>
...
//std C++
#include <asio2/bho/intrusive/detail/minimal_less_equal_header.hpp>   //std::equal_to
...
struct prime_list_holder
{
   ...
   template <class SizeType>  //sizeof(SizeType) > sizeof(std::size_t)
   static BHO_INTRUSIVE_FORCEINLINE SizeType suggested_upper_bucket_count_dispatch(SizeType n, detail::true_)
   {
   ...
   template <class SizeType>  //sizeof(SizeType) > sizeof(std::size_t)
   static BHO_INTRUSIVE_FORCEINLINE SizeType suggested_lower_bucket_count_dispatch(SizeType n, detail::true_)
   {
      std::size_t const c = n > std::size_t(-1)
                            ? std::size_t(-1)
   ...
   static BHO_INTRUSIVE_FORCEINLINE SizeType suggested_upper_bucket_count_dispatch(SizeType n, detail::false_)
   {
   ...
   template <class SizeType>
   static BHO_INTRUSIVE_FORCEINLINE SizeType suggested_lower_bucket_count_dispatch(SizeType n, detail::false_)
   {
   ...
   static std::size_t suggested_lower_bucket_count_impl(std::size_t n)
   {
      ...
      BHO_INTRUSIVE_INVARIANT_ASSERT(bound != primes_end);
...
//We only support LLP64(Win64) or LP64(most Unix) data models
   ...
   #define BHO_INTRUSIVE_PRIME_C(NUMBER) NUMBER##ULL
   #define BHO_INTRUSIVE_64_BIT_SIZE_T 1
#else //In 32 bit windows and 32/64 bit unixes sizeof(size_t) == sizeof(unsigned long)
   #define BHO_INTRUSIVE_PRIME_C(NUMBER) NUMBER##UL
   #define BHO_INTRUSIVE_64_BIT_SIZE_T (((((ULONG_MAX>>16)>>16)>>16)>>15) != 0)
#endif

template<int Dummy>
const std::size_t prime_list_holder<Dummy>::prime_list[] = {
   BHO_INTRUSIVE_PRIME_C(3),                     BHO_INTRUSIVE_PRIME_C(7),
   BHO_INTRUSIVE_PRIME_C(11),                    BHO_INTRUSIVE_PRIME_C(17),
   BHO_INTRUSIVE_PRIME_C(29),                    BHO_INTRUSIVE_PRIME_C(53),
   BHO_INTRUSIVE_PRIME_C(97),                    BHO_INTRUSIVE_PRIME_C(193),
   BHO_INTRUSIVE_PRIME_C(389),                   BHO_INTRUSIVE_PRIME_C(769),
   BHO_INTRUSIVE_PRIME_C(1543),                  BHO_INTRUSIVE_PRIME_C(3079),
   BHO_INTRUSIVE_PRIME_C(6151),                  BHO_INTRUSIVE_PRIME_C(12289),
   BHO_INTRUSIVE_PRIME_C(24593),                 BHO_INTRUSIVE_PRIME_C(49157),
   BHO_INTRUSIVE_PRIME_C(98317),                 BHO_INTRUSIVE_PRIME_C(196613),
   BHO_INTRUSIVE_PRIME_C(393241),                BHO_INTRUSIVE_PRIME_C(786433),
   BHO_INTRUSIVE_PRIME_C(1572869),               BHO_INTRUSIVE_PRIME_C(3145739),
   BHO_INTRUSIVE_PRIME_C(6291469),               BHO_INTRUSIVE_PRIME_C(12582917),
   BHO_INTRUSIVE_PRIME_C(25165843),              BHO_INTRUSIVE_PRIME_C(50331653),
   BHO_INTRUSIVE_PRIME_C(100663319),             BHO_INTRUSIVE_PRIME_C(201326611),
   BHO_INTRUSIVE_PRIME_C(402653189),             BHO_INTRUSIVE_PRIME_C(805306457),
   BHO_INTRUSIVE_PRIME_C(1610612741),            BHO_INTRUSIVE_PRIME_C(3221225473),
#if BHO_INTRUSIVE_64_BIT_SIZE_T
   //Taken from BHO.MultiIndex code, thanks to Joaquin M Lopez Munoz.
   BHO_INTRUSIVE_PRIME_C(6442450939),            BHO_INTRUSIVE_PRIME_C(12884901893),
   BHO_INTRUSIVE_PRIME_C(25769803751),           BHO_INTRUSIVE_PRIME_C(51539607551),
   BHO_INTRUSIVE_PRIME_C(103079215111),          BHO_INTRUSIVE_PRIME_C(206158430209),
   BHO_INTRUSIVE_PRIME_C(412316860441),          BHO_INTRUSIVE_PRIME_C(824633720831),
   BHO_INTRUSIVE_PRIME_C(1649267441651),         BHO_INTRUSIVE_PRIME_C(3298534883309),
   BHO_INTRUSIVE_PRIME_C(6597069766657),         BHO_INTRUSIVE_PRIME_C(13194139533299),
   BHO_INTRUSIVE_PRIME_C(26388279066623),        BHO_INTRUSIVE_PRIME_C(52776558133303),
   BHO_INTRUSIVE_PRIME_C(105553116266489),       BHO_INTRUSIVE_PRIME_C(211106232532969),
   BHO_INTRUSIVE_PRIME_C(422212465066001),       BHO_INTRUSIVE_PRIME_C(844424930131963),
   BHO_INTRUSIVE_PRIME_C(1688849860263953),      BHO_INTRUSIVE_PRIME_C(3377699720527861),
   BHO_INTRUSIVE_PRIME_C(6755399441055731),      BHO_INTRUSIVE_PRIME_C(13510798882111483),
   BHO_INTRUSIVE_PRIME_C(27021597764222939),     BHO_INTRUSIVE_PRIME_C(54043195528445957),
   BHO_INTRUSIVE_PRIME_C(108086391056891903),    BHO_INTRUSIVE_PRIME_C(216172782113783843),
   BHO_INTRUSIVE_PRIME_C(432345564227567621),    BHO_INTRUSIVE_PRIME_C(864691128455135207),
   BHO_INTRUSIVE_PRIME_C(1729382256910270481),   BHO_INTRUSIVE_PRIME_C(3458764513820540933),
   BHO_INTRUSIVE_PRIME_C(6917529027641081903),   BHO_INTRUSIVE_PRIME_C(13835058055282163729),
   BHO_INTRUSIVE_PRIME_C(18446744073709551557),  BHO_INTRUSIVE_PRIME_C(18446744073709551615)   //Upper limit, just in case
#else
   BHO_INTRUSIVE_PRIME_C(4294967291),            BHO_INTRUSIVE_PRIME_C(4294967295)             //Upper limit, just in case
#endif
   };

#undef BHO_INTRUSIVE_PRIME_C
...
struct group_functions
{
   ...
   BHO_INTRUSIVE_FORCEINLINE static void erase_from_group(const slist_node_ptr&, const node_ptr&, detail::false_)
   {}
   ...
   BHO_INTRUSIVE_FORCEINLINE static node_ptr next_group_if_first_in_group(node_ptr ptr)
   {
   ...
   BHO_INTRUSIVE_FORCEINLINE static void insert_in_group(node_ptr first_in_group, node_ptr n, true_)
   {  group_algorithms::link_after(first_in_group, n);  }

   static void insert_in_group(const node_ptr&, const node_ptr&, false_)
   {}

   BHO_INTRUSIVE_FORCEINLINE static node_ptr split_group(node_ptr const new_first_in_group)
   {
...
{
   BHO_INTRUSIVE_FORCEINLINE static void store_hash(typename NodeTraits::node_ptr p, std::size_t h, true_)
   {  return NodeTraits::set_hash(p, h); }

   BHO_INTRUSIVE_FORCEINLINE static void store_hash(typename NodeTraits::node_ptr, std::size_t, false_)
   {}
};
...
BHO_INTRUSIVE_FORCEINLINE std::size_t hash_to_bucket_split(std::size_t hash_value, std::size_t bucket_cnt, std::size_t split)
{
   ...
   :  public detail::node_to_value<ValueTraits, IsConst>
{
   ...
   BHO_INTRUSIVE_FORCEINLINE downcast_node_to_value_t(const const_value_traits_ptr &ptr)
      :  base_t(ptr)
   {}
...
struct bucket_plus_vtraits
{
   ...
   BHO_INTRUSIVE_FORCEINLINE bucket_plus_vtraits(const ValueTraits &val_traits, BHO_FWD_REF(BucketTraitsType) b_traits)
      :  data(val_traits, ::bho::forward<BucketTraitsType>(b_traits))
   {}

   BHO_INTRUSIVE_FORCEINLINE bucket_plus_vtraits & operator =(const bucket_plus_vtraits &x)
   ...
   std::size_t priv_bucket_count() const BHO_NOEXCEPT
   {
   ...
   {
      BHO_INTRUSIVE_INVARIANT_ASSERT(n < this->priv_bucket_traits().bucket_count());
      return priv_bucket_pointer()[std::ptrdiff_t(n)];
   }

   BHO_INTRUSIVE_FORCEINLINE bucket_ptr priv_invalid_bucket() const
   {
      const bucket_traits &rbt = this->priv_bucket_traits();
      return rbt.bucket_begin() + std::ptrdiff_t(rbt.bucket_count());
   }

   BHO_INTRUSIVE_FORCEINLINE siterator priv_invalid_local_it() const
   ...
   BHO_INTRUSIVE_FORCEINLINE static std::size_t priv_stored_hash(slist_node_ptr n, detail::true_) //store_hash
   {  return node_traits::get_hash(detail::dcast_bucket_ptr<node>(n));  }

   BHO_INTRUSIVE_FORCEINLINE static std::size_t priv_stored_hash(slist_node_ptr, detail::false_)  //NO store_hash
   {  return std::size_t(-1);   }
   ...
   BHO_INTRUSIVE_FORCEINLINE reference priv_value_from_slist_node(slist_node_ptr n)
   {  return *this->priv_value_traits().to_value_ptr(detail::dcast_bucket_ptr<node>(n)); }

   BHO_INTRUSIVE_FORCEINLINE const_reference priv_value_from_slist_node(slist_node_ptr n) const
   {  return *this->priv_value_traits().to_value_ptr(detail::dcast_bucket_ptr<node>(n)); }
   ...
   {
      template<class BucketTraitsType>
      BHO_INTRUSIVE_FORCEINLINE data_type(const ValueTraits &val_traits, BHO_FWD_REF(BucketTraitsType) b_traits)
         : ValueTraits(val_traits), bucket_traits_(::bho::forward<BucketTraitsType>(b_traits))
      {}
   ...
   , bucket_plus_vtraits<ValueTraits, BucketTraits>  //4
{
   ...
   template<class BucketTraitsType>
   BHO_INTRUSIVE_FORCEINLINE bucket_hash_t(const ValueTraits &val_traits, BHO_FWD_REF(BucketTraitsType) b_traits, const hasher & h)
      :  detail::ebo_functor_holder<hasher>(h), bucket_plus_vtraits_t(val_traits, ::bho::forward<BucketTraitsType>(b_traits))
   {}
   ...
   , public hashtable_equal_holder<ValueTraits, BucketTraits, VoidOrKeyOfValue, VoidOrKeyEqual>::type //equal
{
   ...
   template<class BucketTraitsType>
   bucket_hash_equal_t(const ValueTraits &val_traits, BHO_FWD_REF(BucketTraitsType) b_traits, const hasher & h, const key_equal &e)
      : bucket_hash_type(val_traits, ::bho::forward<BucketTraitsType>(b_traits), h)
      , equal_holder_t(e)
   {}
   ...
   BHO_INTRUSIVE_FORCEINLINE void priv_set_cache(const bucket_ptr &)
   {}

   BHO_INTRUSIVE_FORCEINLINE std::size_t priv_get_cache_bucket_num()
   {  return 0u;  }

   BHO_INTRUSIVE_FORCEINLINE void priv_initialize_cache()
   {}
   ...
   , hashtable_equal_holder<ValueTraits, BucketTraits, VoidOrKeyOfValue, VoidOrKeyEqual>::type
{
   ...
   BHO_INTRUSIVE_FORCEINLINE const bucket_ptr &priv_get_cache() const
   {  return cached_begin_;   }

   BHO_INTRUSIVE_FORCEINLINE void priv_set_cache(const bucket_ptr &p)
   {  cached_begin_ = p;   }
   ...
   {
      BHO_INTRUSIVE_INVARIANT_ASSERT(insertion_bucket < this->bucket_hash_type::priv_bucket_count());
   ...
   : public DeriveFrom
{
   ...
   hashtable_size_traits_wrapper( BHO_FWD_REF(Base) base, BHO_FWD_REF(Arg0) arg0
   ...
   BHO_INTRUSIVE_FORCEINLINE size_traits_const_t priv_size_traits() const
   {  return size_traits_; }
   ...
   : public DeriveFrom
{
   ...
   BHO_INTRUSIVE_FORCEINLINE size_traits priv_size_traits() const
   {  return size_traits(); }
};
      ...
      >
{
   ...
   template<class BucketTraitsType>
   hashdata_internal( const ValueTraits &val_traits, BHO_FWD_REF(BucketTraitsType) b_traits
                    , const hasher & h, const key_equal &e)
      :  internal_type(val_traits, ::bho::forward<BucketTraitsType>(b_traits), h, e)
   {}

   BHO_INTRUSIVE_FORCEINLINE typename internal_type::size_traits_t priv_split_traits()
   {  return this->priv_size_traits();  }

   BHO_INTRUSIVE_FORCEINLINE typename internal_type::size_traits_const_t priv_split_traits() const
   {  return this->priv_size_traits();  }
   ...
   BHO_INTRUSIVE_FORCEINLINE iterator iterator_to(reference value) BHO_NOEXCEPT
   {
      ...
      >
{
   ...
   hashtable_impl(BHO_RV_REF(hashtable_impl) x)
      : internal_type( ::bho::move(x.priv_value_traits())
                     , ::bho::move(x.priv_bucket_traits())
                     , ::bho::move(x.priv_hasher())
                     , ::bho::move(x.priv_equal())
                     )
   {
   ...
   bool incremental_rehash(const bucket_traits &new_bucket_traits) BHO_NOEXCEPT
   {
      ...
      BHO_INTRUSIVE_INVARIANT_ASSERT(sizeof(SizeType) >= sizeof(std::size_t) || new_bucket_count <= SizeType(-1));
   ...
   static siterator priv_last_in_group(const siterator &it_first_in_group) BHO_NOEXCEPT
   {
      ...
      , size_type &cnt) const
   {
      ...
      if(to_return.first != to_return.second){
         ...
         if(optimize_multikey){
            ...
            internal_cnt += bho::intrusive::iterator_udistance(++it, to_return.second);
         }
         else{
   ...
   size_type priv_get_bucket_num(siterator it) BHO_NOEXCEPT
   {  return this->priv_get_bucket_num_hash_dispatch(it, store_hash_t());  }

   size_type priv_get_bucket_num_hash_dispatch(siterator it, detail::true_) BHO_NOEXCEPT    //store_hash
   {
   ...
   static siterator priv_get_previous(bucket_type &b, siterator i) BHO_NOEXCEPT
