...
class tree_iterator
{
   ...
   BHO_INTRUSIVE_FORCEINLINE explicit tree_iterator(const node_ptr & nodeptr, const const_value_traits_ptr &traits_ptr)
   ...
   BHO_INTRUSIVE_FORCEINLINE tree_iterator &operator=(const node_ptr &nodeptr)
