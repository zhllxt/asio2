#ifndef BHO_CORE_CMATH_HPP_INCLUDED
#define BHO_CORE_CMATH_HPP_INCLUDED
...
inline bool signbit( float x )
{
    ...
    BHO_STATIC_ASSERT( sizeof( x ) == sizeof( y ) );
...
#else // defined(BHO_CORE_USE_GENERIC_CMATH)
...
{
    return bho::core::isnormal( static_cast<double>( x ) );
}
...
inline int fpclassify( float x )
{
    ...
    default:
        ...
        return bho::core::isnormal( x )? fp_normal: fp_subnormal;
    }
}
...
{
    return bho::core::fpclassify( static_cast<double>( x ) );
}
...
template<class T> T copysign( T x, T y )
{
    return bho::core::detail::copysign_impl( x, y );
}
...
#endif // defined(BHO_CORE_USE_GENERIC_CMATH)

#endif  // #ifndef BHO_CORE_CMATH_HPP_INCLUDED
