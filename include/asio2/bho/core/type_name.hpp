#ifndef BHO_CORE_TYPE_NAME_HPP_INCLUDED
#define BHO_CORE_TYPE_NAME_HPP_INCLUDED
...
// std::string bho::core::type_name<T>()
//
...
{
    std::string r = bho::core::demangle( n );
...
#if defined(BHO_MSVC) && BHO_MSVC == 1600
...
template<> struct tn_holder<bho::long_long_type>
{
    static std::string type_name( std::string const& suffix )
    {
...
template<> struct tn_holder<bho::ulong_long_type>
{
    static std::string type_name( std::string const& suffix )
    {
...
#if !defined(BHO_NO_CXX11_REF_QUALIFIERS)
...
#if !defined(BHO_NO_CXX11_HDR_FUNCTIONAL)
...
#endif  // #ifndef BHO_CORE_TYPE_NAME_HPP_INCLUDED
