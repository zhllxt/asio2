#ifndef BHO_CORE_LIGHTWEIGHT_TEST_HPP
#define BHO_CORE_LIGHTWEIGHT_TEST_HPP
...
//
//  bho/core/lightweight_test.hpp - lightweight test library
//
...
#ifndef BHO_LIGHTWEIGHT_TEST_OSTREAM
# define BHO_LIGHTWEIGHT_TEST_OSTREAM std::cerr
#endif
...
{
    bho::detail::test_result& result = bho::detail::test_results();
    result.done();
...
#define BHO_TEST_NOT(expr) BHO_TEST(!(expr))

#define BHO_ERROR(msg) ( ::bho::detail::error_impl(msg, __FILE__, __LINE__, BHO_CURRENT_FUNCTION) )

#define BHO_TEST_WITH(expr1,expr2,predicate) ( ::bho::detail::test_with_impl(predicate, #expr1, #expr2, __FILE__, __LINE__, BHO_CURRENT_FUNCTION, expr1, expr2) )

#define BHO_TEST_EQ(expr1,expr2) ( ::bho::detail::test_with_impl(::bho::detail::lw_test_eq(), #expr1, #expr2, __FILE__, __LINE__, BHO_CURRENT_FUNCTION, expr1, expr2) )
#define BHO_TEST_NE(expr1,expr2) ( ::bho::detail::test_with_impl(::bho::detail::lw_test_ne(), #expr1, #expr2, __FILE__, __LINE__, BHO_CURRENT_FUNCTION, expr1, expr2) )

#define BHO_TEST_LT(expr1,expr2) ( ::bho::detail::test_with_impl(::bho::detail::lw_test_lt(), #expr1, #expr2, __FILE__, __LINE__, BHO_CURRENT_FUNCTION, expr1, expr2) )
#define BHO_TEST_LE(expr1,expr2) ( ::bho::detail::test_with_impl(::bho::detail::lw_test_le(), #expr1, #expr2, __FILE__, __LINE__, BHO_CURRENT_FUNCTION, expr1, expr2) )
#define BHO_TEST_GT(expr1,expr2) ( ::bho::detail::test_with_impl(::bho::detail::lw_test_gt(), #expr1, #expr2, __FILE__, __LINE__, BHO_CURRENT_FUNCTION, expr1, expr2) )
#define BHO_TEST_GE(expr1,expr2) ( ::bho::detail::test_with_impl(::bho::detail::lw_test_ge(), #expr1, #expr2, __FILE__, __LINE__, BHO_CURRENT_FUNCTION, expr1, expr2) )

#define BHO_TEST_CSTR_EQ(expr1,expr2) ( ::bho::detail::test_cstr_eq_impl(#expr1, #expr2, __FILE__, __LINE__, BHO_CURRENT_FUNCTION, expr1, expr2) )
#define BHO_TEST_CSTR_NE(expr1,expr2) ( ::bho::detail::test_cstr_ne_impl(#expr1, #expr2, __FILE__, __LINE__, BHO_CURRENT_FUNCTION, expr1, expr2) )

#define BHO_TEST_ALL_EQ(begin1, end1, begin2, end2) ( ::bho::detail::test_all_eq_impl(BHO_LIGHTWEIGHT_TEST_OSTREAM, __FILE__, __LINE__, BHO_CURRENT_FUNCTION, begin1, end1, begin2, end2) )
#define BHO_TEST_ALL_WITH(begin1, end1, begin2, end2, predicate) ( ::bho::detail::test_all_with_impl(BHO_LIGHTWEIGHT_TEST_OSTREAM, __FILE__, __LINE__, BHO_CURRENT_FUNCTION, begin1, end1, begin2, end2, predicate) )

#ifndef BHO_NO_EXCEPTIONS
   #define BHO_TEST_THROWS( EXPR, EXCEP )                           \
      try {                                                           \
         EXPR;                                                        \
         ::bho::detail::throw_failed_impl                           \
         (#EXPR, #EXCEP, __FILE__, __LINE__, BHO_CURRENT_FUNCTION); \
      }                                                               \
      catch(EXCEP const&) {                                           \
         ::bho::detail::test_results();                             \
      }                                                               \
...
#ifndef BHO_NO_EXCEPTIONS
#  define BHO_TEST_NO_THROW(EXPR)                                    \
    try {                                                              \
        EXPR;                                                          \
    } catch (const std::exception& e) {                                \
        ::bho::detail::no_throw_failed_impl                          \
        (#EXPR, e.what(), __FILE__, __LINE__, BHO_CURRENT_FUNCTION); \
    } catch (...) {                                                    \
        ::bho::detail::no_throw_failed_impl                          \
        (#EXPR, __FILE__, __LINE__, BHO_CURRENT_FUNCTION);           \
    }
    //
#else
#  define BHO_TEST_NO_THROW(EXPR) { EXPR; }
#endif

#endif // #ifndef BHO_CORE_LIGHTWEIGHT_TEST_HPP
