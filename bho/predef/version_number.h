...
#ifndef BHO_PREDEF_VERSION_NUMBER_H
#define BHO_PREDEF_VERSION_NUMBER_H
...
[source]
----
BHO_VERSION_NUMBER(major,minor,patch)
----
...
*/ // end::reference[]
#define BHO_VERSION_NUMBER(major,minor,patch) \
    ( (((major)%100)*10000000) + (((minor)%100)*100000) + ((patch)%100000) )

#define BHO_VERSION_NUMBER_MAX \
    BHO_VERSION_NUMBER(99,99,99999)

#define BHO_VERSION_NUMBER_ZERO \
    BHO_VERSION_NUMBER(0,0,0)

#define BHO_VERSION_NUMBER_MIN \
    BHO_VERSION_NUMBER(0,0,1)

#define BHO_VERSION_NUMBER_AVAILABLE \
    BHO_VERSION_NUMBER_MIN

#define BHO_VERSION_NUMBER_NOT_AVAILABLE \
    BHO_VERSION_NUMBER_ZERO

/* tag::reference[]
[source]
----
BHO_VERSION_NUMBER_MAJOR(N), BHO_VERSION_NUMBER_MINOR(N), BHO_VERSION_NUMBER_PATCH(N)
----
...
respectively.
*/ // end::reference[]
#define BHO_VERSION_NUMBER_MAJOR(N) \
    ( ((N)/10000000)%100 )

#define BHO_VERSION_NUMBER_MINOR(N) \
    ( ((N)/100000)%100 )

#define BHO_VERSION_NUMBER_PATCH(N) \
    ( (N)%100000 )
