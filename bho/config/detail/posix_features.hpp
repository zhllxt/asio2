...
#     if defined(_POSIX_THREADS) && (_POSIX_THREADS+0 >= 0) && !defined(BHO_HAS_WINTHREADS) && !defined(BHO_HAS_MPTASKS)
...
#     endif
      ...
      // BHO_HAS_GETTIMEOFDAY:
      // BHO_HAS_PTHREAD_MUTEXATTR_SETTYPE:
