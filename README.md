...
* 代码基于asio构建，使用了C++11，采用URL字符串方式建立server或client连接；
* 已将asio代码摘出并引入，无需安装asio和openssl库，所有代码均是hpp文件，以源码级链入，只需在工程的Include包含目录中添加asio2路径，然后在源码中#include <asio2/asio2.hpp>包含头文件即可；
