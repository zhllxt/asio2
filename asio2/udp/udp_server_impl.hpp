...
namespace asio2
{
	...
	public:
		...
		{
			return (m_acceptor_impl_ptr ? m_acceptor_impl_ptr->get_send_pending() : static_cast<std::size_t>(0));
		}
		...
		{
			return (m_acceptor_impl_ptr ? m_acceptor_impl_ptr->get_recv_pending() : static_cast<std::size_t>(0));
		}
