...
#ifndef ASIO2_PFR_DETAIL_CORE17_HPP
#define ASIO2_PFR_DETAIL_CORE17_HPP
...
constexpr bool do_structured_bindings_work() noexcept { // ******************************************* IN CASE OF ERROR READ THE FOLLOWING LINES IN pfr/detail/core17.hpp FILE:
    ...
    * structured bindings.
    *
    * Workaround: Define ASIO2_PFR_USE_CPP17 to 0
    * It will disable the C++17 features for PFR library.
    *
...
static_assert(
    ...
    "====================> PFR: Your compiler can not handle C++17 structured bindings. Read the above comments for workarounds."
);
...
#endif // ASIO2_PFR_DETAIL_CORE17_HPP
