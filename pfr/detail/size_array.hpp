...
#ifndef ASIO2_PFR_DETAIL_SIZE_ARRAY_HPP
#define ASIO2_PFR_DETAIL_SIZE_ARRAY_HPP
#pragma once
...
constexpr std::size_t get(const size_array<N>& a) noexcept {
    static_assert(I < N, "====================> PFR: Array index out of bounds");
    return a.data[I];
}
...
#endif // ASIO2_PFR_DETAIL_SIZE_ARRAY_HPP
