...
#ifndef ASIO2_PFR_DETAIL_CAST_TO_LAYOUT_COMPATIBLE_HPP
#define ASIO2_PFR_DETAIL_CAST_TO_LAYOUT_COMPATIBLE_HPP
#pragma once
...
constexpr void static_assert_layout_compatible() noexcept {
    static_assert(
        ...
        "====================> PFR: Alignment check failed, probably your structure has user-defined alignment for the whole structure or for some of the fields."
    );
    static_assert(sizeof(T) == sizeof(U), "====================> PFR: Size check failed, probably your structure has bitfields or user-defined alignment.");
}
...
#endif // ASIO2_PFR_DETAIL_CAST_TO_LAYOUT_COMPATIBLE_HPP
