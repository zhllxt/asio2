...
#ifndef ASIO2_PFR_DETAIL_FUNCTIONAL_HPP
#define ASIO2_PFR_DETAIL_FUNCTIONAL_HPP
#pragma once
...
namespace pfr { namespace detail {
    ...
    std::size_t compute_hash(const T& /*value*/, int /*priority*/) {
        static_assert(sizeof(T) && false, "====================> PFR: std::hash not specialized for type T");
        return 0;
    }
...
#endif // ASIO2_PFR_DETAIL_FUNCTIONAL_HPP
