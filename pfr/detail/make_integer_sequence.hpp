...
#ifndef ASIO2_PFR_DETAIL_MAKE_INTEGER_SEQUENCE_HPP
#define ASIO2_PFR_DETAIL_MAKE_INTEGER_SEQUENCE_HPP
#pragma once
...
#if ASIO2_PFR_USE_STD_MAKE_INTEGRAL_SEQUENCE == 0

#ifdef __has_builtin
#   if __has_builtin(__make_integer_seq)
#       define ASIO2_PFR_USE_MAKE_INTEGER_SEQ_BUILTIN
#   endif
#endif

#ifdef ASIO2_PFR_USE_MAKE_INTEGER_SEQ_BUILTIN
...
#undef ASIO2_PFR_USE_MAKE_INTEGER_SEQ_BUILTIN
...
#endif // !defined ASIO2_PFR_USE_MAKE_INTEGER_SEQ_BUILTIN
#else // ASIO2_PFR_USE_STD_MAKE_INTEGRAL_SEQUENCE == 1

template <typename T, T N>
using make_integer_sequence = std::make_integer_sequence<T, N>;

#endif // ASIO2_PFR_USE_STD_MAKE_INTEGRAL_SEQUENCE == 1
