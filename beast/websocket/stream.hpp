...
#include <beast/websocket/impl/stream_impl.hpp> // must be first
#include <beast/websocket/impl/accept.hpp>
#include <beast/websocket/impl/close.hpp>
#include <beast/websocket/impl/handshake.hpp>
#include <beast/websocket/impl/ping.hpp>
#include <beast/websocket/impl/read.hpp>
#include <beast/websocket/impl/stream.hpp>
#include <beast/websocket/impl/write.hpp>
